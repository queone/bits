...
| 54 | Foundational problems belong to society under rules that outlast any donor; a billionaire should attack them and then hand them back, because single ownership brings control, ego, and continuity risk; a problem is real when theory clashes with observation, not when the picture looks ugly. | `society/whose-problem.md` | settled |
